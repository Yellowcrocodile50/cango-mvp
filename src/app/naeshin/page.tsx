...
const NAESHIN_DESCRIPTION =
  "무료 내신 계산기 - 지금까지의 내신 성적으로 목표 대학 합격을 위해 남은 학기에 필요한 등급을 예측하세요. 간호학과·보건계열(임상병리·방사선·물리치료·치위생)은 물론 의대·공대·자연계, 사범대(교육학·국어교육·영어교육)·법학과·미디어커뮤니케이션·정치외교 등 문과 학과까지, 38개 대학 23개 학과의 학생부교과전형 등급컷으로 지원 가능 대학을 확인할 수 있어요.";
