    ...
    <div className="fixed bottom-8 right-6 z-50">
      ...
      >
        <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#3A1D1D">
          <path d="M12 3C6.477 3 2 6.701 2 11.25c0 2.85 1.696 5.367 4.29 6.916-.172.61-.625 2.208-.715 2.55-.112.42.153.414.322.302.132-.088 2.1-1.425 2.953-2.002.698.098 1.415.15 2.15.15 5.523 0 10-3.701 10-8.25C22 6.7 17.523 3 12 3z" />
        </svg>
